...
class _GameMediumState extends State<GameMedium>
  ...
  List<GlobalKey<FlipTileState>> flipTileKeys = List.generate(25, (index) => GlobalKey<FlipTileState>());  
  ...
  void initializeGridColors() {
    gridColors = _isDarkMode
        ? List.generate(25, (index) => const Color.fromARGB(255, 50, 50, 50))  
        : List.generate(25, (index) => const Color.fromARGB(255, 250, 250, 250));  
  }
          ...
          actions: [
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color.fromARGB(255, 255, 182, 190),  
                          ...
                          onTap: () {
                            ...
                            if (user == null) {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      HistoryPage(isDarkMode: _isDarkMode),  
                                ),
                              );
                            }
                          },
